...
describe('Extract SVG viewBox', function() {
  describe('Extract a viewBox', function() {
    it('should return a matching viewBox', function() {
      const viewBox = extract(`<svg viewBox="0 0 460 460" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      const viewBoxExpected = '0 0 460 460'
      assert.equal(viewBox, viewBoxExpected)
    })
  })
})
